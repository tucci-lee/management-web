  ...
  <div style="padding-top: 10%">
    <el-form :model="loginData" class="loginBox" :rules="rules" ref="loginForm">
      ...
      <el-form-item prop="account">
        <el-input v-model="loginData.account" placeholder="账号"></el-input>
      </el-form-item>
      ...
      <el-row>
        <el-col :span="14">
          <el-form-item prop="code">
            <el-input v-model="loginData.kaptcha" placeholder="图形验证码"
...
export default {
  ...
  methods: {
     ...
     */
    refreshCodeimg() {
      this.codeimg = this.$axios.defaults.baseURL + '/kaptcha?' + Math.random();
    },
    /**
     * 登陆
     */
