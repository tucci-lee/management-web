    ...
    <div>
        ...
        <div style="margin-bottom: 10px">
            <el-form inline size="small">
                ...
                <el-form-item>
                    <el-select v-model="search.lockFlag" placeholder="状态" clearable>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-tag @click="editLock(scope.row)"
                            :type="scope.row.lockFlag? 'danger' : 'primary'"
                            disable-transitions>{{scope.row.lockFlag?'锁定':'正常'}}
                    </el-tag>
                </template>
            </el-table-column>
            <el-table-column
            ...
            <el-form :model="data.editRole" :rules="rules.editRole" ref="editRoleForm">
                <el-form-item prop="roleIds">
                    <el-checkbox-group v-model="data.editRole.roleIds">
                        <el-checkbox v-for="role in roleData" :key="role.roleId" :label="role.roleId">{{role.name}}
                        </el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="添加用户" width="30%" center :visible.sync="show.add" @close="show.add=false">
            <el-form :model="data.add" :rules="rules.add" ref="addForm" label-width="80px">
                <el-form-item label="账号" prop="username">
                    <el-input v-model="data.add.username"></el-input>
                </el-form-item>
            ...
            <el-tabs type="card" v-model="editTabs">
                <el-tab-pane label="修改用户" name="editTab">
                    <el-form :model="data.edit" :rules="rules.edit" ref="editForm" label-width="80px">
                        <el-form-item label="账号" prop="username">
                            <el-input v-model="data.edit.username" disabled></el-input>
                        </el-form-item>
                        <el-form-item label="手机号" prop="phone">
