<template>
  <div>
    ...
    <el-dialog title="添加部门" width="30%" center :visible.sync="show.add" @close="show.add=false">
      <el-form :model="data.add" :rules="rules" ref="addForm" label-width="100px">
        ...
        <el-form-item label="负责人" prop="manager">
          <el-input v-model="data.add.manager"></el-input>
        </el-form-item>
        <el-form-item label="负责人手机" prop="managerPhone">
          <el-input v-model="data.add.managerPhone"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改部门" width="30%" center :visible.sync="show.edit" @close="show.edit=false">
      <el-form :model="data.edit" :rules="rules" ref="editForm" label-width="100px">
        <el-form-item label="上级部门" prop="pid">
        ...
        <el-form-item label="负责人" prop="manager">
          <el-input v-model="data.edit.manager"></el-input>
        </el-form-item>
        <el-form-item label="负责人手机" prop="managerPhone">
          <el-input v-model="data.edit.managerPhone"></el-input>
        </el-form-item>
        <el-form-item label="排序" prop="seq">
  ...
  methods: {
    ...
    deleteDept(dept) {
      this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
        ...
        this.$axios.delete("/sys/dept/" + dept.id)
            .then(res => {
              if (!res.data.status) {
                return;
              }
